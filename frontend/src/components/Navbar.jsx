  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 bottom-0 z-20 overflow-hidden bg-white`}>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                    ...
                    <NavLink onClick={() => setShowMenu(false)} to='/about'><p className='px-4 rounded inline-block' >ABOUT US</p></NavLink>
